...
//    public static final int SYNC_INTERVAL = 30;
    ...
    private void updateWearable(double high, double low, int weatherId) {
        ...
        PutDataMapRequest putDataMapRequest = PutDataMapRequest.create(getContext().getResources().getString(R.string.wearable_data_item_path));
        putDataMapRequest.getDataMap().putDouble(getContext().getResources().getString(R.string.wearable_data_item_high_temp), high);
        putDataMapRequest.getDataMap().putDouble(getContext().getResources().getString(R.string.wearable_data_item_low_temp), low);
